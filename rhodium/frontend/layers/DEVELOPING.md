...
|---|---|---|---|
| Packed expressions and selection | [`comb.rhm`](comb.rhm), [`bool.rhm`](bool.rhm), [`signed.rhm`](signed.rhm), [`expanding-arithmetic.rhm`](expanding-arithmetic.rhm) | fields, literals, exact and priority mux lookup, masks, one-hot selection | [`../../../rhodium/frontend/tests/comparison-test.rhm`](../../../rhodium/frontend/tests/comparison-test.rhm), [`../../../rhodium/frontend/tests/priority-mux-test.rhm`](../../../rhodium/frontend/tests/priority-mux-test.rhm), [`../../../rhodium/frontend/tests/concat-test.rhm`](../../../rhodium/frontend/tests/concat-test.rhm), [`../../../rhodium/frontend/tests/signed-test.rhm`](../../../rhodium/frontend/tests/signed-test.rhm), [`../../../rhodium/frontend/tests/expanding-arithmetic-test.rhm`](../../../rhodium/frontend/tests/expanding-arithmetic-test.rhm) |
| Nominal and structural data | [`enum.rhm`](enum.rhm), [`tagged-union.rhm`](tagged-union.rhm), [`one-hot.rhm`](one-hot.rhm), [`bundle.rhm`](bundle.rhm), [`vector.rhm`](vector.rhm) | fields, hardware methods, literals, variants, generator parameters | [`../../../rhodium/frontend/tests/enum-test.rhm`](../../../rhodium/frontend/tests/enum-test.rhm), [`../../../rhodium/frontend/tests/tagged-union-test.rhm`](../../../rhodium/frontend/tests/tagged-union-test.rhm), [`../../../rhodium/frontend/tests/bundle-test.rhm`](../../../rhodium/frontend/tests/bundle-test.rhm), [`../../../rhodium/frontend/tests/vector-test.rhm`](../../../rhodium/frontend/tests/vector-test.rhm) |
...
tools/run-racket-tests.sh \
  rhodium/frontend/tests/enum-test.rhm \
  rhodium/frontend/tests/enum-method-test.rhm
```

Then select the checks required by the change:

- Run `bash rhodium/frontend/tests/run-negative.sh` after changing diagnostics,
