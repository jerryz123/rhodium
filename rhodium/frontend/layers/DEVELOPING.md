...
|---|---|---|---|
| Packed expressions and selection | [`comb.rhm`](comb.rhm), [`bool.rhm`](bool.rhm), [`signed.rhm`](signed.rhm), [`expanding-arithmetic.rhm`](expanding-arithmetic.rhm) | fields, literals, mux lookup, masks, one-hot selection | [`../../../rhodium/frontend/tests/comparison-test.rhm`](../../../rhodium/frontend/tests/comparison-test.rhm), [`../../../rhodium/frontend/tests/concat-test.rhm`](../../../rhodium/frontend/tests/concat-test.rhm), [`../../../rhodium/frontend/tests/signed-test.rhm`](../../../rhodium/frontend/tests/signed-test.rhm), [`../../../rhodium/frontend/tests/expanding-arithmetic-test.rhm`](../../../rhodium/frontend/tests/expanding-arithmetic-test.rhm) |
