<!-- Explains event inference, timed snapshots, shared C++ Perfetto export, and validation. -->
...
`TRACE_PROCESSOR=/path/to/trace_processor_shell bash tests/backend/run-event-perfetto.sh`
