...
module rv5stage_fp_pipeline_tb;
  ...
  typedef struct packed {
    logic valid;
    FloatingPointRegisterWrite bits;
  } vector_write_t;
  ...
  vector_reserve_t vector_reserve_in;
  vector_write_t vector_write_in;
  ...
  struct packed {logic ready;} vector_reserve_out;
  ...
  initial begin
    ...
    issue_in.bits.control.execution.destination_precision = 2'd2;
    issue_in.bits.control.execution.integer_width = 2'd2;
    ...
    issue_in.bits.control.registers.uses_frs1 = 1'b1;
    issue_in.bits.control.registers.destination = 2'd1;
    issue_in.bits.control.execution.unit = 4'd14;
    issue_in.bits.control.execution.source_precision = 2'd2;
    issue_in.bits.control.execution.integer_width = 2'd2;
