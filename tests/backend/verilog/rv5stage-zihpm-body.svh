...
// SPDX-License-Identifier: Apache-2.0
  ...
  RV5StageCsrFile dut (.vector_state(), .vector_enabled(), .vector_retire_in('0), .vector_saturate_in('0), .vector_fault_start_in('0), .pointer_masking(), .pointer_masking_changed(), .*);
