...
`endif
  ...
  typedef struct packed { logic valid; logic [199:0] bits; } branch_update_t;
  typedef struct packed {
    logic active;
    pulse_t flush;
  ...
  logic [200:0] branch_update_in = '0;
...
`endif
  ...
  always_comb begin
    ...
    control_in.branch_update.valid = branch_update_in[200];
    control_in.branch_update.bits = branch_update_in[199:0];
