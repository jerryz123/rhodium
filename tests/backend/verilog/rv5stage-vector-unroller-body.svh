...
// SPDX-License-Identifier: Apache-2.0
  ...
  typedef struct packed { logic [SW-1:0] operation_sequence; logic [CW-1:0] first, ending; logic last, reduction, scan; logic [63:0] scan_carry; logic scalar_destination; logic [4:0] destination; logic memory, floating_point, multiply_divide, divide, multiply_accumulate, multiply_subtract, store, saturated; logic [5:0] shift; write_t write; logic [63:0] compress_data; logic [3:0] compress_count; logic [CW-1:0] compress_destination; } result_t;
