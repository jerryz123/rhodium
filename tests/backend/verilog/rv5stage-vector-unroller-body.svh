...
// SPDX-License-Identifier: Apache-2.0
  ...
  typedef struct packed { logic [CW-1:0] first, ending; logic last, reduction, scalar_destination; logic [4:0] destination; logic memory, floating_point, multiply_divide, divide, store; logic [5:0] shift; write_t write; } result_t;
