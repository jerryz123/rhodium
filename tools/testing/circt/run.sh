...
integration_fixtures=(
  ...
  fesvr-mmio aclint bootrom boot-address plic uart16550 uart-dpi hdmi-frame-reader chi-foundation chi-full-flits chi-link chi-monitor chi-transaction chi-retryable-transaction chi-transaction-sn chi-coherent chi-ram chi-home chi-coherent-home chi-inclusive-home chi-read-once-home chi-read-stream chi-snp-noc chi-sn-noc chi-family-noc chi-router-composition chi-transfer-fragmenter
...
fixture_in_group() {
  ...
  case "$group:$wanted" in
    ...
    std:retained-flow-map|std:cache-replacement|std:shift-queue|std:round-robin-matcher|std:credited-flow|std:credited-monitor|std:credited-monitor-overgrant|std:expand-mask|std:runtime-alignment|std:transfer-range)
      return 0
      ;;
    protocols:fesvr-mmio|protocols:aclint|protocols:bootrom|protocols:boot-address|protocols:plic|protocols:uart16550|protocols:uart-dpi|protocols:hdmi-frame-reader|protocols:noc-wormhole|protocols:noc-router-family|protocols:noc-escape-router|protocols:chi-*)
      return 0
      ;;
