<!-- Describes the public boundary of CHI network integration. -->

# CHI network integration

Pure compilation of CHI connections and hardware adapters/router composition over validated NoC plans.
