...
| Checking and control | [`transactions/monitor.rhdl`](transactions/monitor.rhdl), [`transactions/transaction.rhdl`](transactions/transaction.rhdl), [`transactions/coherent-transaction.rhdl`](transactions/coherent-transaction.rhdl), [`transactions/retryable-transaction.rhdl`](transactions/retryable-transaction.rhdl), [`transactions/read-once.rhdl`](transactions/read-once.rhdl) | Link assertions, bounded transaction checks, reusable retry association, and complete-line RN-I snapshot reads |
