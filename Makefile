...
event-runtime-test: check-boundaries
	FIXTURES="event-runtime event-pipeline event-elastic event-queue event-arbiter event-demux event-atomic-fork event-broadcast event-join event-stall event-offer event-retained" bash tests/backend/run-circt.sh
