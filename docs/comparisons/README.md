<!-- Summarizes Rhodium's distinguishing choices and indexes language and compiler comparisons. -->
...
[layered authoring examples](../../examples/lop/) show the same circuit at
several language layers.
...
The [NoC library](../../noc/README.md) analyzes symbolic topology and routing
before RTL construction, checking reachability and deadlock under documented
VC assumptions and retaining failure witnesses for the authored network. These
