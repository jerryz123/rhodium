...
and ordered/unordered indexed segment catalogs expose the memory subgroups.
...
`VectorMemoryInstructions` excludes fault-only-first, mask-register, and
whole-register transfers. Vector operands use `RegisterBank.Vector`, with
