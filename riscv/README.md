...
ordered/unordered indexed segment, and fault-only-first catalogs expose the
memory subgroups.
...
`VectorMemoryInstructions` excludes mask-register and whole-register
transfers. Vector operands use `RegisterBank.Vector`, with
