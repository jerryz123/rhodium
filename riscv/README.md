...
and 8/16/32/64-bit index EEW. Unit-stride fault-only-first loads include
...
ordered/unordered indexed segment, fault-only-first, and whole-register
...
`VectorMemoryInstructions` excludes mask-register transfers. Vector operands
