...
`vsmul`. Each operation has `.vv` and `.vx` forms using the canonical
OPMVV/OPMVX encodings. `VectorMultiplyDivideInstructions` composes those three
catalogs; rounding and sticky saturation remain core policy.
